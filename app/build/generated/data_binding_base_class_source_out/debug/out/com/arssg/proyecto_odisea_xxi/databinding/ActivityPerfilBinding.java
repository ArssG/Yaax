...
public final class ActivityPerfilBinding implements ViewBinding {
  ...
  private ActivityPerfilBinding(@NonNull ConstraintLayout rootView,
      @NonNull BottomNavigationView bottomNavigation, @NonNull Button button10,
      @NonNull Button button9, @NonNull ImageView imageView2, @NonNull TextView textView,
  ...
  public static ActivityPerfilBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPerfilBinding((ConstraintLayout) rootView, bottomNavigation, button10,
          button9, imageView2, textView, textView2, textView3);
    }
